...
RoleState ResolveRoleState(const InputState &inputs, const LayerState &layer, const EffectiveDirectionState &directions) {
    ...
    const bool rf4_behavior_available = inputs.rf4 && !rf4_modifier_suppressed_by_cstick;
    ...
    const bool rf3_x_suppressed_by_rf9 = base_rf3_x_active && inputs.rf9 && !layer.c_stick_any_active;
    const bool rf3_x_restored_by_cstick = base_rf3_x_active && inputs.rf9 && layer.c_stick_any_active;
