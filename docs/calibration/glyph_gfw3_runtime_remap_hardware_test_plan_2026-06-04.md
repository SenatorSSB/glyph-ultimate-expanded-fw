...
| rf9_rf4_null_disabled | RF9+RF4 exception | `RF9 + RF4` plus LS/C-stick directions | 1..9 plus C-stick smoke | RF9 performs no left-stick null, no right-stick null, and does not replace RF4 modifier behavior | NOT_EXECUTED |
