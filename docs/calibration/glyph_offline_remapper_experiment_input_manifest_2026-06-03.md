...
| `generated_config_prototype` | `docs/calibration/fixtures/glyph_identity_runtime_generated_config_prototype_2026-05-28.json` | `6ce5a6296edb4becfce08eb31b2e2dbbd6750d5b2af962c2c5631baded18032d` | `reference_only` | `reference-only generated config source` | `repo_fixture_evidence` | Reference-only generated config source; docs/tools-only artifact, not external remapper import candidate, not runtime-loaded config, and not hardware validation. |
