...
| `senscope_export_package_sample` | `docs/calibration/fixtures/glyph_senscope_export_package_SAMPLE_2026-06-03.json` | `ec5f33640be0375c1a3ba5b175c39ce3f78c459891ba724d3519d16b939609a0` | `reference_only` | `reference-only package, not expected external remapper import unless future adapter exists` | `repo_fixture_evidence` | Reference-only package; do not treat as direct import candidate, runtime-loaded config, device write payload, or official compatibility evidence. |
