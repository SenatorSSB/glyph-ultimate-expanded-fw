...
- `glyph_phase7a_diagnostic_d3_global_parse_result_only_hardware_plan_2026-06-09.md` -
  diagnostic D3 hardware plan (template-style evidence scaffold); all rows are
  `NOT_TESTED` in this branch and the branch is not a merge candidate.
...
- `glyph_phase7a_diagnostic_d5a_n2_resolver_without_parse_status_read_hardware_plan_2026-06-09.md` -
  diagnostic D5A-N2 hardware plan (template-style evidence scaffold) for resolver
  runtime path with parse-status hot-path reads removed.
- `fixtures/glyph_phase7a_diagnostic_d5a_n2_resolver_without_parse_status_read_hardware_plan_2026-06-09.json` -
  matching diagnostic D5A-N2 hardware plan fixture.
...
- `fixtures/glyph_phase7a_diagnostic_d5a_n2_resolver_without_parse_status_read_hardware_result_2026-06-09.json`
  - matching machine-readable D5A-N2 hardware result fixture.
