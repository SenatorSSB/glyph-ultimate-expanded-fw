...
| Identity runtime role/case canonicalization | COMPLETE | `docs/calibration/glyph_identity_runtime_role_map_2026-05-28.md`, `docs/calibration/glyph_identity_runtime_behavior_cases_2026-05-28.md` | Source-backed role map and representative behavior-case matrix are documented with fixtures/checkers. |
...
| Identity runtime behavior case matrix | COMPLETE | `docs/calibration/glyph_identity_runtime_behavior_cases_2026-05-28.md`, `docs/calibration/fixtures/glyph_identity_runtime_behavior_cases_2026-05-28.json`, `tools/check_glyph_identity_runtime_behavior_cases.py` |
