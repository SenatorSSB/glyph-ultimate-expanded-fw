...
```json
{
  ...
  "audit_base_sha": "31bdbbc83f3129ecb9cbf5bc4ad20e073bdd60a4",
  ...
  "items": [
    {
      ...
      "status": "READY",
      "done_evidence": "Pending exact independently reviewed ignored-directory repair, focused and full aggregate PASS on the actual caller with existing ignored state, live canonical integration, and separate renewed completion correspondence. Prior reviewed completion is preserved historically in GP_VAL_011_RECOVERY_ADJUDICATION.md.",
      ...
      "why_this_matters": "The reviewed isolated runner rejects an otherwise clean legitimate caller when Git collapses an ignored nested repository into a directory entry. The blanket original contract permits pre-existing ignored caller-local state while excluding it from the clone. Final main-checkout validation exposed this original implementation gap after prior temporary-clone PASS.",
      "hardware_risk": "H1",
      ...
      "authorization_snapshot_provenance": "Fresh independent Curator /root/contract_curator on 2026-09-07 against independently live-verified canonical 31bdbbc83f3129ecb9cbf5bc4ad20e073bdd60a4 and actual clean main checkout failure /private/tmp/glyph-final-main-aggregate.json. Publish this exact reopened READY contract before implementation; obtain a different fresh implementation reviewer and full main-checkout validation before renewed DONE.",
      ...
      "rollback_recovery": "If exact closed repair or full validation fails, leave this work noncomplete and preserve the current fail-closed isolated runner and reviewed historical snapshots; do not restore direct canonical checker execution, discard caller ignored state, or weaken proof to obtain PASS.",
      "status_documentation_updates": "Record this exact original ignored-directory implementation defect and reopening, retain historical prior feature/integration/completion evidence, and renew DONE only after reviewed implementation is live and real clean main-checkout full aggregate passes unchanged caller proof. Refresh material Planner/Curator provenance after completion; no global wait while repair remains.",
      "stop_conditions": [
...
No new independent candidate is promoted. Completed implementation and research history remains in the canonical work orders. Future persistence durability/recovery policy and modifier intent remain separately owner-gated; no H3 mechanism or gameplay semantics is selected. That prior wait judgment is superseded by the recorded ignored-directory failure; the exact reopened GP-VAL-011 repair is now authorized independent work.
