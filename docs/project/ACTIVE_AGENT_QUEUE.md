  ...
  "items": [
    {
      ...
      "substantive_authorization_rationale": "Fresh independent recovery Curator selects Path A: the same H1 validation isolation objective remains valid. Source determines two exact self-test environment exceptions and one immutable historical ref without changing checker commands, applicability, semantics, firmware, hardware, product policy, or external authority. Those omissions require a narrow contract rebind rather than implementation-author interpretation. Census report loss, detached symbolic-ref rc1 rejection, caller expected-base replacement, and incomplete setup/process/deadline/fingerprint proof are repairable implementation defects within the original exact runner/adversarial safety objective. No additional ambient inheritance or user/product decision is authorized.",
      ...
      "authorization_snapshot_provenance": "Fresh independent read-only recovery Curator /root/contract_curator inspected canonical 2a80462ba2801192154e42ee4bebb9b1b43ca699, latest Planner glyph-portfolio-20260901-0909 at 3fb785749d8653e91bb8e4b3a73a01be03aaf9cb, canonical final-survivor curation c9de4685846ec359e49e3650cde6db13f262656e, exact GP-VAL-011 contract, unchanged context/X1 checkers, manifest/census/health, and both failed local commits on 2026-09-06. This judgment is independent of implementation authorship and is not postimplementation review or merge authority.",
