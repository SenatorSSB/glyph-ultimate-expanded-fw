...
- `GP-CONFIG-004`: `DONE`; exact offline H0 checker/docs correspondence repair
  is independently reviewed, fully validated, merged, and live-verified; no
  real capture was performed or interpreted.
