...
partially consumed after fresh curation. `GP-SRC-003` and `GP-SRC-004` are DONE
on validated implementation branches; `GP-CONFIG-004` and `GP-VAL-003` remain Ready;
