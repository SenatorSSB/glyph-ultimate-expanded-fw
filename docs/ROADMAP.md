...
remains partially consumed because `GP-SRC-003` is now DONE at the reviewed
feature-ref commit `81c91ba31784fa085e5e6f6c21286c2ff28f32f2`. Effective runway
is zero against target four, so fresh curation/planning is required. The current-runway marker above is authoritative for
