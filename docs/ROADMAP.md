...
enforces generic health-prose correspondence against current 31/26 state.
...
enforcement; the effective authorized runway is zero and fresh candidate
supply requires planning/curation.
