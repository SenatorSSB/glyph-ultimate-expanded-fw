...
is build proof only. At that historical completion publication no executable
item remained; the later 2050 packet supersedes that supply state. Deferred
GP-VAL-011 is not executable.
