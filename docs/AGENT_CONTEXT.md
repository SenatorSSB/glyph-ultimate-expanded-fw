...
- The canonical executable queue is
  ...
  `GP-CONFIG-001` as `DONE` and four independent H0/H1 items as `READY`:
  `GP-CONFIG-003`, `GP-PROV-001`, `GP-VAL-001`, and `GP-SRC-002`. No
  ...
  of four; liveness is `RUNWAY_OK`. Historical or unreviewed candidate supply
