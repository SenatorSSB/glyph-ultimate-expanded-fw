...
Future realization strategy should pivot away from `RuntimeConfigView`
replacement as the active customization mechanism unless a narrower
source-backed diagnostic proves otherwise.
