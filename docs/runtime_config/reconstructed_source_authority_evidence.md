...
| --- | --- | --- | --- |
| `current_source_owned_baseline` | `current` / `HARDWARE_PASS` | `SOURCE_EQUIVALENCE_ONLY` | merge_approved=true is recorded, but no intake-contract approver identifier is recorded |
