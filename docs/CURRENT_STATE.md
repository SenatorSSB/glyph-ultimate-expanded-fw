...
Status label: CURRENT. <!-- current-runway:start -->{"ready_ids":["GP-VAL-026"],"immediate_ready":1,"recorded_preauthorized":3,"mechanically_activatable_preauthorized":0,"invalidated_preauthorized":0,"hardware_pending":1,"effective_authorized_runway":1,"target_effective_authorized_runway":4,"primary_liveness":"RUNWAY_LOW","global_evidence_wait_supported":false}
<!-- current-runway:end -->
