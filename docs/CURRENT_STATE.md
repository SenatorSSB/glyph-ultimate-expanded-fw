...
Status label: CURRENT. <!-- current-runway:start -->{"ready_ids":["GP-SRC-009","GP-VAL-021","GP-VAL-022","GP-CONFIG-009"],"immediate_ready":4,"recorded_preauthorized":1,"mechanically_activatable_preauthorized":0,"invalidated_preauthorized":0,"hardware_pending":0,"effective_authorized_runway":4,"target_effective_authorized_runway":4,"primary_liveness":"RUNWAY_OK","global_evidence_wait_supported":false}
<!-- current-runway:end -->
