    ...
    .game_mode_configs = {
        ...
        GameModeConfig {
            ...
            .socd_pairs = {
                ...
                SocdPair { .button_dir1 = BTN_LF5, .button_dir2 = BTN_LF2, .socd_type = SOCD_2IP },
            ...
            .button_remapping_count = 42,
            .button_remapping = {
                ButtonRemap { .physical_button = BTN_LF2, .activates = BTN_LF2 },
                ButtonRemap { .physical_button = BTN_LF4, .activates = BTN_LF4 },
                ButtonRemap { .physical_button = BTN_LT1, .activates = BTN_LT1 },
                ButtonRemap { .physical_button = BTN_RF1, .activates = BTN_RF1 },
                ...
                ButtonRemap { .physical_button = BTN_RF13, .activates = BTN_RF13 },
                ButtonRemap { .physical_button = BTN_LF6, .activates = BTN_LF6 },
                ButtonRemap { .physical_button = BTN_RF11, .activates = BTN_RF11 },
                ButtonRemap { .physical_button = BTN_RF10, .activates = BTN_RF10 },
                ButtonRemap { .physical_button = BTN_LT3, .activates = BTN_LT3 },
                ButtonRemap { .physical_button = BTN_LF7, .activates = BTN_LF7 },
                ButtonRemap { .physical_button = BTN_LF8, .activates = BTN_LF8 },
                ButtonRemap { .physical_button = BTN_LT2, .activates = BTN_LT2 },
                ButtonRemap { .physical_button = BTN_LT4, .activates = BTN_LT4 },
                ButtonRemap { .physical_button = BTN_LT5, .activates = BTN_LT5 },
                ButtonRemap { .physical_button = BTN_RF9, .activates = BTN_RF9 },
                ButtonRemap { .physical_button = BTN_RF12, .activates = BTN_RF12 },
                ButtonRemap { .physical_button = BTN_RF14, .activates = BTN_RF14 },
                ButtonRemap { .physical_button = BTN_RF15, .activates = BTN_RF15 },
                ButtonRemap { .physical_button = BTN_RF16, .activates = BTN_RF16 },
                ButtonRemap { .physical_button = BTN_MB1, .activates = BTN_MB1 },
                ButtonRemap { .physical_button = BTN_MB2, .activates = BTN_MB2 },
                ButtonRemap { .physical_button = BTN_MB3, .activates = BTN_MB3 },
                ButtonRemap { .physical_button = BTN_MB4, .activates = BTN_MB4 },
                ButtonRemap { .physical_button = BTN_MB5, .activates = BTN_MB5 },
                ButtonRemap { .physical_button = BTN_MB6, .activates = BTN_MB6 },
                ButtonRemap { .physical_button = BTN_MB7, .activates = BTN_MB7 },
                ButtonRemap { .physical_button = BTN_RF2, .activates = BTN_RF2 },
                ButtonRemap { .physical_button = BTN_LF3, .activates = BTN_LF3 },
                ButtonRemap { .physical_button = BTN_LF1, .activates = BTN_LF1 },
                ButtonRemap { .physical_button = BTN_RF7, .activates = BTN_RF7 },
                ButtonRemap { .physical_button = BTN_RF8, .activates = BTN_RF8 },
                ButtonRemap { .physical_button = BTN_RT3, .activates = BTN_RT3 },
                ButtonRemap { .physical_button = BTN_RT5, .activates = BTN_RT5 },
                ButtonRemap { .physical_button = BTN_RT2, .activates = BTN_RT2 },
                ButtonRemap { .physical_button = BTN_RT4, .activates = BTN_RT4 },
            },
            .rgb_config = 3,
            .layout_plate = LAYOUT_PLATE_EVERYTHING,
            .applicable_backends_count = 4,
