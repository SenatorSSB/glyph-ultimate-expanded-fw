...
REQUIRED_DOC_PHRASES = [
    ...
    "inspect the branch diff before merge",
    "run checks after merge before starting the next branch",
    "expected fail",
    "explicitly exists to add a failing test",
    "another branch in the same atomic sequence is guaranteed to fix it before merge",
    ...
    "these gates do not authorize bypassing user review",
    "merging known-failing branches",
    "changing the workflow protocol into implementation behavior",
]
