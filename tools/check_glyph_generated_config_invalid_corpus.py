#!/usr/bin/env python3
"""Validate the offline invalid-corpus for the Glyph generated-config validator."""
...
def load_corpus() -> dict[str, Any]:
    ...
    expected = {
        ...
        "baseline_fixture": "docs/calibration/fixtures/glyph_identity_runtime_generated_config_prototype_2026-05-28.json",
    }
...
def main() -> int:
    print("glyph_generated_config_invalid_corpus")
    try:
        corpus = load_corpus()
        baseline = load_json_object(BASELINE_FIXTURE_PATH)
        if validate_generated_config(baseline):
            fail("baseline generated-config fixture must pass the validator")
