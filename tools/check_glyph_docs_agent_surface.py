...
def main() -> int:
    try:
        ...
        validate_feature_scope(
            context,
            allowed_paths=("docs/", "tools/", ".github/workflows/build.yml", "AGENTS.md", "CLAUDE.md", "src/modes/runtime_config/generated_source_owned/GeneratedRuntimeConfigBaseline.current.hpp"),
