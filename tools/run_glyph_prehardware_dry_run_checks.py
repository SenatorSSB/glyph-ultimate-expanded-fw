...
def default_commands() -> list[CommandSpec]:
    return [
        ...
        CommandSpec("tools/check_glyph_smashbox_profile_tables.py"),
        CommandSpec("tools/check_glyph_smashbox_modifiers_runtime_source.py"),
        CommandSpec("tools/check_glyph_smashbox_identity_runtime_bindings.py"),
        ...
        CommandSpec("tools/check_glyph_ultimate_identity_profile_baseline.py"),
