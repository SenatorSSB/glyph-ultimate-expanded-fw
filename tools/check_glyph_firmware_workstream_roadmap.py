...
REQUIRED_FILES = [
    ...
    "docs/calibration/fixtures/glyph_physical_logical_rf5_gap_index_2026-06-06.json",
    "tools/check_glyph_physical_logical_rf5_gap_index.py",
    "docs/calibration/glyph_next_user_action_handoff_2026-06-06.md",
    "docs/calibration/fixtures/glyph_next_user_action_handoff_2026-06-06.json",
    ...
    "docs/calibration/glyph_clean_room_adapter_sidecar_contract_2026-06-04.md",
    ...
    "docs/calibration/fixtures/glyph_external_remapper_import_export_audit_checklist_2026-06-04.json",
    ...
    "tools/check_glyph_gfw3_runtime_remap_rework_spec.py",
    ...
    "tools/check_glyph_gfw3_runtime_remap_hardware_test_plan.py",
...
REQUIRED_ROADMAP_PHRASES = [
    ...
    "choose/prioritize generated C++ constants path/export target contract/runtime-loaded config design/transport source research",
    "Routine engineering design and source research are not user-domain-blocked",
    ...
    "tools/check_glyph_official_configurator_export_corpus.py",
    "tools/check_glyph_external_remapper_misattribution_correction.py",
    "approve before risky implementation",
    "hardware results only after a test artifact exists",
    ...
    "Glyph clean-room adapter sidecar contract",
    "glyph/gfw2-clean-room-adapter-sidecar-contract",
    ...
    "Glyph clean-room adapter negative corpus contract",
    "glyph/gfw2-clean-room-adapter-negative-corpus-contract",
    ...
    "Glyph clean-room adapter invalid corpus fixture",
    "glyph/gfw2-clean-room-adapter-invalid-corpus-fixture",
    "docs_tools_invalid_corpus",
    "candidate-schema invalid fixture corpus only",
    "covers every invalid category from the clean-room adapter negative corpus contract",
    ...
    "Glyph clean-room adapter invalid corpus checker",
    "glyph/gfw2-clean-room-adapter-invalid-corpus-checker",
    "validates the invalid corpus as a planning fixture, not as implementation",
    "loads the negative corpus contract, invalid corpus fixture, and candidate schema placeholder",
    ...
    "does not claim official compatibility or hardware validation",
    "Glyph clean-room adapter transform design contract",
    "glyph/gfw2-clean-room-adapter-transform-design-contract",
    ...
    "no external dependency",
    "no device write/WebSerial/protobuf/runtime-loaded config",
    "Glyph clean-room adapter transform rule matrix",
    "glyph/gfw2-clean-room-adapter-transform-rule-matrix",
    ...
    "rules classify future clean-room transform categories only",
    "no transform implementation",
    "no external JSON generation",
    "no transform code",
    "no device write/WebSerial/protobuf/runtime-loaded config",
    "Glyph clean-room adapter transform decision matrix",
    "glyph/gfw2-clean-room-adapter-transform-decision-matrix",
    ...
    "whether the external remapper is allowed as a visual editor",
    "whether runtime-owned behavior is represented only in sidecar",
    "whether SOCD policy is sidecar-only or a profile-level candidate",
    ...
    "whether repeated no-device experiment with browser/version recorded is required",
    "whether source audit is required before implementation",
    "whether license review is required before code reuse",
    ...
    "not official configurator compatibility",
    "not hardware validation",
    "Glyph external remapper import/export audit scope",
    "glyph/gfw2-external-remapper-import-export-audit-scope",
    ...
    "Glyph external remapper import/export audit checklist",
    "glyph/gfw2-external-remapper-import-export-checklist",
    "planned_not_executed",
    ...
    "Final blocker packet records `official_configurator_corpus_present_initial`, `corpus_present=true`, and `completion_allowed=false`",
    ...
    "Roadmap status semantics cleanup",
    "tools/check_glyph_roadmap_status_semantics.py",
    "separate status from requirement fields",
    "ready engineering design",
    "ready source research",
    "product approval gates",
    "without treating every future phase as user-domain-blocked",
]
