...
ALLOWED_PATH_RE = re.compile(
    r"^(?:docs/runtime_config/|docs/export/|docs/agent_framework/|docs/calibration/|docs/project/ACTIVE_AGENT_QUEUE\.md|docs/AGENT_CONTEXT\.md|docs/CURRENT_STATE\.md|docs/ROADMAP\.md|tools/|\.github/workflows/build\.yml|"
