...
ALLOWED_DOC_PATHS = {
    ...
    "docs/runtime_config/source_owned_candidate_generation_diff_diagnosis.md",
    "docs/runtime_config/fixtures/source_owned_candidate_generation_diff_diagnosis.json",
